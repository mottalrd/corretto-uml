...
public class RadarTXT {
	...
	public static void main(String[] args){
		...
		//t.generateZOTFile(100, "meezot", "minisat", new File("output/txt_model.lisp").getAbsolutePath());
		t.generateZOTFile(100, "ae2zot", "z3", new File("output/txt_model.lisp").getAbsolutePath());
	...
	private static void create_txt_model() {
		...
		UML2Helper.createTransition(smMainMMI, s0, s1, "@ckMainMMI.tick/@MainMMIToEnvironment.start");
		...
		//SD PANEL DATA
		org.eclipse.uml2.uml.Interaction SDPanelDataToEnvironment=UML2Helper.createInteraction(systemPackage, "PanelDataToEnvironment");
		l1=SDPanelDataToEnvironment.createLifeline("l1");
		l1.setSelector(panelData.getSpecification());
		l2=SDPanelDataToEnvironment.createLifeline("l2");
		l2.setSelector(environment.getSpecification());
		UML2Helper.createMessage(SDPanelDataToEnvironment, l1, l2, swEnvironmentop13, "panel_getLed");
		UML2Helper.createMessage(SDPanelDataToEnvironment, l1, l1, swPanelDataop3, "processData");
		UML2Helper.createMessage(SDPanelDataToEnvironment, l1, l2, swEnvironmentop14, "panel_setButton");
		UML2Helper.createMessage(SDPanelDataToEnvironment, l1, l1, swPanelDataop5, "showData");
		
		//STD PANEL DATA
		org.eclipse.uml2.uml.StateMachine SMPanelData=UML2Helper.createStateMachine(swPanelData, "SMPanelData");
		UML2Helper.createRegion(SMPanelData);
		s0=UML2Helper.createInitialState(SMPanelData, "initial");
		s1=UML2Helper.createState(SMPanelData, "PanelDataState");
		UML2Helper.createTransition(SMPanelData, s0, s1, "@ckPanelData.tick/@PanelDataToEnvironment.start");
		...
		l1=SDRadarDataToEnvironment.createLifeline("l1");
		l1.setSelector(radarData.getSpecification());
		l2=SDRadarDataToEnvironment.createLifeline("l2");
		l2.setSelector(environment.getSpecification());
		UML2Helper.createMessage(SDRadarDataToEnvironment, l1, l2, swEnvironmentop18, "radar_getCmd");
		UML2Helper.createMessage(SDRadarDataToEnvironment, l1, l1, swRadarDataop3, "processData");
		UML2Helper.createMessage(SDRadarDataToEnvironment, l1, l2, swEnvironmentop19, "radar_setSts");
		UML2Helper.createMessage(SDRadarDataToEnvironment, l1, l2, swEnvironmentop20, "radar_setResult");
		...
		s0=UML2Helper.createInitialState(SMRadarData, "initial");
		s1=UML2Helper.createState(SMRadarData, "RadarDataState");
		UML2Helper.createTransition(SMRadarData, s0, s1, "@ckRadar.tick/@RadarDataToEnvironment.start");
		...
		l1=SDNavigationToEnvironment.createLifeline("l1");
		l1.setSelector(navData.getSpecification());
		l2=SDNavigationToEnvironment.createLifeline("l2");
		l2.setSelector(environment.getSpecification());
		...
		UML2Helper.createMessage(SDNavigationToEnvironment, l1, l2, swEnvironmentop11, "radar_setLatitude");
		UML2Helper.createMessage(SDNavigationToEnvironment, l1, l2, swEnvironmentop12, "radar_setLongitude");
		...
		s0=UML2Helper.createInitialState(SMNavData, "initial");
		s1=UML2Helper.createState(SMNavData, "NavDataState");
		UML2Helper.createTransition(SMNavData, s0, s1, "@ckNavigation.tick/@NavigationToEnvironment.start");
		...
		l1=SDWeatherDataToEnvironment.createLifeline("l1");
		l1.setSelector(weatherData.getSpecification());
		l2=SDWeatherDataToEnvironment.createLifeline("l2");
		l2.setSelector(environment.getSpecification());
		UML2Helper.createMessage(SDWeatherDataToEnvironment, l1, l2, swEnvironmentop15, "weather_getNewImage");
		UML2Helper.createMessage(SDWeatherDataToEnvironment, l1, l1, swWeatherDataop3, "processData");
		UML2Helper.createMessage(SDWeatherDataToEnvironment, l1, l2, swEnvironmentop17, "weather_setStatus");
		...
		s0=UML2Helper.createInitialState(SMWeatherData, "initial");
		s1=UML2Helper.createState(SMWeatherData, "WeatherDataState");
		UML2Helper.createTransition(SMWeatherData, s0, s1, "@ckWeather.tick/@WeatherDataToEnvironment.start");
	...
	private static void create_txt_model2(int num_processes){
		//Preparazione modello e package
		Model myModel = UML2Helper.createModel("Radar TXT");
		org.eclipse.uml2.uml.Profile madesProfile = UML2Helper.loadProfile(MADES_PROFILE_PATH);
		myModel.createElementImport(madesProfile);
