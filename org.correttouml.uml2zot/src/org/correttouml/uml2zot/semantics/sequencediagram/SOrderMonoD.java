...
public class SOrderMonoD implements BooleanFormulae, MetaBooleanFormulae{
    ...
    public SOrderMonoD(BooleanFormulae f1, BooleanFormulae f2, BooleanFormulae guard, BooleanFormulae exception, Boolean isConcurrent, String comment){
        this.f1=f1;
        this.f2=f2;
        this.guard = guard;
        this.exception = exception;
    ...
    public SOrderMonoD(BooleanFormulae f1, BooleanFormulae f2, BooleanFormulae exception, Boolean isConcurrent, String comment){
        this.f1=f1;
        this.f2=f2;
        this.exception = exception;
        this.isConcurrent = isConcurrent;
	...
	public String toString() {
    	...
    	for (BooleanFormulae f: getFormulae()) {
    		if (f instanceof MetaBooleanFormulae && ((MetaBooleanFormulae) f).getComment()!="")
    			s += ";;[SOrderMonoD]" + ((MetaBooleanFormulae)f).getComment() + "\n";
    		s += f.toString() + "\n";
    	}
    	return s;
	}
