...
public class PropertyGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CorrettoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Corretto");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TRIOElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TRIO");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TRIORElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TRIOR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ArithBoolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ArithBool");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ArithTermElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ArithTerm");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ArithTermLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ArithTermL");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class ArithTermRElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ArithTermR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ArithVarElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ArithVar");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	private CorrettoElements pCorretto;
	private TerminalRule tEXECUTE;
	private VerifyElements pVerify;
	private DeclarationElements pDeclaration;
	private TRIOElements pTRIO;
	private TRIOLElements pTRIOL;
	private TRIORElements pTRIOR;
	private TerminalRule tTRIOOP2;
	private TerminalRule tTRIOOPF;
	private TerminalRule tTRIOOPFF;
	private TerminalRule tTRIOOPFN;
	private ArithBoolElements pArithBool;
	private ArithTermElements pArithTerm;
	private ArithTermLElements pArithTermL;
	private ArithTermRElements pArithTermR;
	private ArithVarElements pArithVar;
	private DataTypeElements pDataType;
	private TerminalRule tFLOAT;
	private TerminalRule tARITH_OP;
	private TerminalRule tARITH_COMPARE_OP;
	...
	public CorrettoElements getCorrettoAccess() {
		return (pCorretto != null) ? pCorretto : (pCorretto = new CorrettoElements());
	}
	...
	public TerminalRule getEXECUTERule() {
		return (tEXECUTE != null) ? tEXECUTE : (tEXECUTE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "EXECUTE"));
	} 
	...
	public TRIOElements getTRIOAccess() {
		return (pTRIO != null) ? pTRIO : (pTRIO = new TRIOElements());
	}
	...
	public TRIORElements getTRIORAccess() {
		return (pTRIOR != null) ? pTRIOR : (pTRIOR = new TRIORElements());
	}
	...
	////TRIO propositional operators with 2 operands
	//terminal TRIOOP2:
	//	"&&" | "||" | "=>" | "<=>" | "->" | "<->";
	public TerminalRule getTRIOOP2Rule() {
		return (tTRIOOP2 != null) ? tTRIOOP2 : (tTRIOOP2 = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "TRIOOP2"));
	} 

	////TRIO temporal operators with 1 operands
	//terminal TRIOOPF:
	...
	public TerminalRule getTRIOOPFRule() {
		return (tTRIOOPF != null) ? tTRIOOPF : (tTRIOOPF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "TRIOOPF"));
	} 

	////TRIO temporal operators with 2 formula operands
	//terminal TRIOOPFF:
	//	"until" | "since" | "release" | "trigger";
	public TerminalRule getTRIOOPFFRule() {
		return (tTRIOOPFF != null) ? tTRIOOPFF : (tTRIOOPFF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "TRIOOPFF"));
	} 

	////TRIO temporal operators with 1 formula operand and a number
	//terminal TRIOOPFN:
	//	"futr" | "past" | "withinF" | "withinP" | "lasts" | "lasted";
	public TerminalRule getTRIOOPFNRule() {
		return (tTRIOOPFN != null) ? tTRIOOPFN : (tTRIOOPFN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "TRIOOPFN"));
	} 

	//ArithBool:
	//	arithTerm1=ArithTerm (arithCOP=ARITH_COMPARE_OP arithTerm2=ArithTerm)?;
	public ArithBoolElements getArithBoolAccess() {
		return (pArithBool != null) ? pArithBool : (pArithBool = new ArithBoolElements());
	}
	...
	public ArithTermElements getArithTermAccess() {
		return (pArithTerm != null) ? pArithTerm : (pArithTerm = new ArithTermElements());
	}
	...
	public ArithTermLElements getArithTermLAccess() {
		return (pArithTermL != null) ? pArithTermL : (pArithTermL = new ArithTermLElements());
	}
	...
	public ArithTermRElements getArithTermRAccess() {
		return (pArithTermR != null) ? pArithTermR : (pArithTermR = new ArithTermRElements());
	}
	...
	public TerminalRule getARITH_OPRule() {
		return (tARITH_OP != null) ? tARITH_OP : (tARITH_OP = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ARITH_OP"));
	} 

	//terminal ARITH_COMPARE_OP:
	//	">" | ">=" | "<" | "<=" | "==" | "!=";
	public TerminalRule getARITH_COMPARE_OPRule() {
		return (tARITH_COMPARE_OP != null) ? tARITH_COMPARE_OP : (tARITH_COMPARE_OP = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ARITH_COMPARE_OP"));
	} 
