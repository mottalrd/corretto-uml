		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclarationAccess().getAlternatives_1_2_1_1(), "rule__Declaration__Alternatives_1_2_1_1");
					...
					put(grammarAccess.getDeclarationAccess().getGroup_1_2_1_1_0(), "rule__Declaration__Group_1_2_1_1_0__0");
					put(grammarAccess.getDeclarationAccess().getGroup_1_2_1_1_1(), "rule__Declaration__Group_1_2_1_1_1__0");
					put(grammarAccess.getTRIOAccess().getGroup(), "rule__TRIO__Group__0");
					put(grammarAccess.getTRIOLAccess().getGroup_1(), "rule__TRIOL__Group_1__0");
					...
					put(grammarAccess.getTRIOLAccess().getGroup_6(), "rule__TRIOL__Group_6__0");
					...
					put(grammarAccess.getArithVarAccess().getGroup_3(), "rule__ArithVar__Group_3__0");
					...
					put(grammarAccess.getDeclarationAccess().getStateNameAssignment_1_2_1_1_0_1(), "rule__Declaration__StateNameAssignment_1_2_1_1_0_1");
					put(grammarAccess.getDeclarationAccess().getOperationNameAssignment_1_2_1_1_1_1(), "rule__Declaration__OperationNameAssignment_1_2_1_1_1_1");
					...
					put(grammarAccess.getTRIOLAccess().getTrioVarAssignment_0(), "rule__TRIOL__TrioVarAssignment_0");
					put(grammarAccess.getTRIOLAccess().getSignalAssignment_1_1(), "rule__TRIOL__SignalAssignment_1_1");
					put(grammarAccess.getTRIOLAccess().getArithBoolAssignment_2(), "rule__TRIOL__ArithBoolAssignment_2");
					put(grammarAccess.getTRIOLAccess().getTrioNotAssignment_3_1(), "rule__TRIOL__TrioNotAssignment_3_1");
					put(grammarAccess.getTRIOLAccess().getTrioOpFAssignment_4_1(), "rule__TRIOL__TrioOpFAssignment_4_1");
					put(grammarAccess.getTRIOLAccess().getTrioOpF1Assignment_4_3(), "rule__TRIOL__TrioOpF1Assignment_4_3");
					put(grammarAccess.getTRIOLAccess().getTrioOpFFAssignment_5_1(), "rule__TRIOL__TrioOpFFAssignment_5_1");
					put(grammarAccess.getTRIOLAccess().getTrioOpFF1Assignment_5_3(), "rule__TRIOL__TrioOpFF1Assignment_5_3");
					put(grammarAccess.getTRIOLAccess().getTrioOpFF2Assignment_5_5(), "rule__TRIOL__TrioOpFF2Assignment_5_5");
					put(grammarAccess.getTRIOLAccess().getTrioOpFNAssignment_6_1(), "rule__TRIOL__TrioOpFNAssignment_6_1");
					put(grammarAccess.getTRIOLAccess().getTrioOpFN1Assignment_6_3(), "rule__TRIOL__TrioOpFN1Assignment_6_3");
					put(grammarAccess.getTRIOLAccess().getIntAssignment_6_5(), "rule__TRIOL__IntAssignment_6_5");
					...
					put(grammarAccess.getArithVarAccess().getStaticVarAssignment_3_1(), "rule__ArithVar__StaticVarAssignment_3_1");
