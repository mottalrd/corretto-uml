...
public interface Event extends EObject
{
   ...
   * @see org.correttouml.grammars.booleanExpressions.BooleanExpressionsPackage#getEvent_EventName()
   * @model
   * @generated
   */
  String getEventName();
  ...
  /**
   * Sets the value of the '{@link org.correttouml.grammars.booleanExpressions.Event#getEventName <em>Event Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.correttouml.grammars.booleanExpressions.BooleanExpressionsPackage#getEvent_EventExtension()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.correttouml.grammars.booleanExpressions.Event#getEventExtension <em>Event Extension</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.correttouml.grammars.booleanExpressions.BooleanExpressionsPackage#getEvent_NowEvent()
   * @model
   * @generated
   */
  boolean isNowEvent();
  ...
  /**
   * Sets the value of the '{@link org.correttouml.grammars.booleanExpressions.Event#isNowEvent <em>Now Event</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
