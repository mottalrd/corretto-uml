...
public class EventImpl extends MinimalEObjectImpl.Container implements Event
{
  ...
  {
    return BooleanExpressionsPackage.Literals.EVENT;
  }
  ...
  public void setEventName(String newEventName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BooleanExpressionsPackage.EVENT__EVENT_NAME, oldEventName, eventName));
  }
  ...
  public void setEventExtension(String newEventExtension)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BooleanExpressionsPackage.EVENT__EVENT_EXTENSION, oldEventExtension, eventExtension));
  }
  ...
  public void setNowEvent(boolean newNowEvent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BooleanExpressionsPackage.EVENT__NOW_EVENT, oldNowEvent, nowEvent));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case BooleanExpressionsPackage.EVENT__NOW_EVENT:
        return isNowEvent();
    }
