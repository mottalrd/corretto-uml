...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return BooleanExpressionsPackage.Literals.MODEL;
  }
  ...
  public NotificationChain basicSetExpression(OrExpression newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BooleanExpressionsPackage.MODEL__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(OrExpression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BooleanExpressionsPackage.MODEL__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BooleanExpressionsPackage.MODEL__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BooleanExpressionsPackage.MODEL__EXPRESSION, newExpression, newExpression));
  }
